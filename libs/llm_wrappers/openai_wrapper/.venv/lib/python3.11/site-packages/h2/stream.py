...
_transitions: dict[
    ...
    (StreamState.CLOSED, StreamInputs.RECV_ALTERNATIVE_SERVICE): (None, StreamState.CLOSED),
...
class H2Stream:
    ...
    def upgrade(self, client_side: bool) -> None:
        ...
        input_ = StreamInputs.UPGRADE_CLIENT if client_side else StreamInputs.UPGRADE_SERVER

        # This may return events, we deliberately don't want them.
        self.state_machine.process_input(input_)

    def send_headers(
        self, headers: Iterable[HeaderWeaklyTyped], encoder: Encoder, end_stream: bool = False
    ...
    def push_stream_in_band(
        self, related_stream_id: int, headers: Iterable[HeaderWeaklyTyped], encoder: Encoder
    ) -> list[HeadersFrame | ContinuationFrame | PushPromiseFrame]:
        """
    ...
    def send_data(
        self, data: bytes | memoryview, end_stream: bool = False, pad_length: int | None = None
    ) -> list[Frame]:
        """
    ...
    def receive_push_promise_in_band(
        self, promised_stream_id: int, headers: Iterable[Header], header_encoding: bool | str | None
    ...
    def receive_headers(
        self, headers: Iterable[Header], end_stream: bool, header_encoding: bool | str | None
    ) -> tuple[list[Frame], list[Event]]:
        """
