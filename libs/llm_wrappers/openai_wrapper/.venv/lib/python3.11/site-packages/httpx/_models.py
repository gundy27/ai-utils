...
class Headers(typing.MutableMapping[str, str]):
    ...
    def multi_items(self) -> list[tuple[str, str]]:
        ...
        """
        return [
            (key.decode(self.encoding), value.decode(self.encoding)) for _, key, value in self._list
        ]
...
class Request:
    def __init__(
        ...
        *,
        ...
        self.method = (
            method.decode("ascii").upper() if isinstance(method, bytes) else method.upper()
        )
        self.url = URL(url)
...
class Response:
    ...
    def links(self) -> dict[str | None, dict[str, str]]:
        ...
        return {(link.get("rel") or link.get("url")): link for link in parse_header_links(header)}
